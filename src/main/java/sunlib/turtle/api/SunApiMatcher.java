...
import static sunlib.turtle.utils.ApiRequest.Type.*;
...
//        add(GET, NanoHTTPD.Method.GET, "/pack/v1");
        ...
        add(GET_CACHE, NanoHTTPD.Method.GET, "/exercise/v1/user_info\\?ts=[0-9]+&callback=[^&]+");
        add(GET_CACHE, NanoHTTPD.Method.GET, "/exercise/v1/achievements\\?ts=[0-9]+&callback=[^&]+");

        // GET  http://127.0.0.1/exercise/v1/lessons/1/%2E%2C%2D.jpg?ts=123456789
        add(GET_CACHE, NanoHTTPD.Method.GET, "/exercise/v1/lessons/[a-z0-9-]+/.+\\.(png|jpg|jpeg|mp4|mp3|pdf)");
...
//        add(GET_CACHE, NanoHTTPD.Method.GET, "/pack/v1/(subjects|folders|pieces)/[a-z0-9]+\\?ts=[0-9]+");
        ...
        add(GET_CACHE, NanoHTTPD.Method.GET, "/exercise/v1/user_data/(subjects|chapters|lessons|achievements|user_info).*");
...
//        add(GET_CACHE, NanoHTTPD.Method.GET, "/pack/v1/user_data/(subjects|folders|pieces|achievements)/[a-z0-9]+");
        ...
        add(POST_CACHE, NanoHTTPD.Method.POST, "/exercise/v1/user_data/(subjects|chapters|lessons|achievements|user_info).*");

        // POST http://127.0.0.1/pack/v1/user_data/subjects/1
        // POST http://127.0.0.1/pack/v1/user_data/achievements/1
//        add(POST_CACHE, NanoHTTPD.Method.POST, "/pack/v1/user_data/(subjects|folders|pieces|achievements|user_info).+");
        ...
        add(BATCH_CACHE, NanoHTTPD.Method.GET, "/exercise/v1/achievements\\?ts=[0-9]+&act=(cache|status).*");
        add(BATCH_CACHE, NanoHTTPD.Method.GET, "/exercise/v1/(chapters|achievements)/[a-z0-9]+\\?ts=[0-9]+&act=(cache|status).*");
        add(BATCH_CACHE, NanoHTTPD.Method.GET, "/exercise/v1/resources\\?ts=[0-9]+&act=(cache|status)&callback=[^&]+");

        add(STATE, NanoHTTPD.Method.GET, "/state/.*");
